...
const NAV_ITEMS = [
  { href: "/dashboard/admin", label: "Tổng quan", icon: "grid_view", exact: true },
  { href: "/dashboard/admin/appointments", label: "Lịch hẹn", icon: "calendar_month" },
  { href: "/dashboard/admin/doctors", label: "Bác sĩ", icon: "stethoscope" },
  { href: "/dashboard/admin/patients", label: "Bệnh nhân", icon: "groups" },
